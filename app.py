...
def tabela_v2():
    ...
    if os.path.exists(resultados_path):
        ...
        resultados = {}
    return render_template('tabela_v2.html', resultados=resultados, placar_atual=placar, partida_atual=partida, jogadores=jogadores.get('jogadores', {}))
...
def links():
    ...
    html_links = {
        ...
        "partida única 1x1": "/partida-unica"  # NOVO LINK
    }
...
# Adicione esta nova rota após a função placar()
@app.route('/partida-unica')
def partida_unica():
    global partida
    # Força os valores para "única" sempre que a página for carregada
    partida["partida"] = "única"
    partida["rodada"] = "única"
    return render_template('partida_unica.html', placar=placar, partida=partida)

# Adicione esta rota para reiniciar a partida única
...
# Adicione esta rota para atualizar apenas os nomes da partida única
...
def get_rota_servidor():
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            # Aqui precisaria parsear o output do ipconfig...
            local_ip = "127.0.0.1"
    except:
        local_ip = "127.0.0.1"
